  ...
  class Bookstore {
    ...
    public function insertAuthor() {
      ...
      if ($_GET["name"] !== "" && $_GET["last_name"] !== "") {
        ...
        $success = insertNewAuthor($this -> connection, $new_author -> getName(), $new_author -> getLastName());
    ...
    public function insertBook() {
      ...
      if ($new_book_title !== "" && $new_book_genre !== "" && $new_book_country !== "" && $new_book_year_published !== "" && $new_book_num_pages !== "" && isset($_GET["author"]) && !empty($_GET["author"])) {
        ...
        $book_success = insertNewBook($this -> connection, $new_book -> getTitle(), $new_book -> getGenre(), $new_book -> getCountry(), $new_book -> getYear(), $new_book -> getPages());
